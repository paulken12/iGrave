...
//
        ...
        LatLng one = new LatLng(16.375848, 120.609034);
        LatLng two = new LatLng(16.375950, 120.609051);
        LatLng three = new LatLng(16.376561, 120.608861);
        LatLng four = new LatLng(16.376641, 120.608517);
...
//                List<DataItems> names = mDataSource.getData(nam);
//
//
//                removeFill();
//                removeLine();
...
//
//                            markers = mMap.addMarker(marker(n.getBlock_name(), n.getLatitude(), n.getLongitude()));
//
...
//                                    .title(n.getFirst_name()+","+n.getLast_name())
...
//                            removeLine();
//                            line = mMap.addPolyline(new PolylineOptions()
//                                    .add(new LatLng(n.getLatitude(), n.getLongitude()),new LatLng(16.376665, 120.608495),new LatLng(16.376568, 120.608833), new LatLng(ur_lat, ur_lon))
//                                    .width(4)
//                                    .color(Color.RED));
//
//                            distance.setText(CalculationByDistance(new LatLng(n.getLatitude(), n.getLongitude()),new LatLng(ur_lat, ur_lon)));
//
//
//
//
//                        for (GridItems gridItems : gridItems) {
//                            double col_lat = gridItems.getCol_grid_lat();
//                            double col_long = gridItems.getCol_grid_long();
//                            double row_lat = gridItems.getRow_grid_lat();
//                            double row_long = gridItems.getRow_grid_long();
//
//                            line = mMap.addPolyline(new PolylineOptions()
//                                    .add(new LatLng(col_lat, col_long), new LatLng(row_lat, row_long))
//                                    .width(1)
//                                    .color(Color.RED));
//
//                        }
...
//                                MarkerOptions mark = new MarkerOptions()
////                                    .title(n.getFirst_name()+" "+n.getLast_name()+" Birthday:" + n.getBirth_date())
//                                        .title(dataItems.getFirst_name()+","+dataItems.getLast_name())
//                                        .position(new LatLng(dataItems.getLatitude(), dataItems.getLongitude()))
//                                        .icon(BitmapDescriptorFactory.defaultMarker());
////                            =======================================================================================
//                                markers = mMap.addMarker(mark);
//                                //line = mMap.addPolyline(drawLine(marker("",dataItems.getLatitude(),dataItems.getLongitude()),marker("",ur_lat,ur_lon)));
...
//                                removeLine();
//                                line = mMap.addPolyline(new PolylineOptions()
//                                        .add(new LatLng(dataItems.getLatitude(), dataItems.getLongitude()),new LatLng(16.376665, 120.608495),new LatLng(16.376568, 120.608833), new LatLng(ur_lat, ur_lon))
//                                        .width(4)
//                                        .color(Color.RED));
//
//                                distance.setText(CalculationByDistance(new LatLng(dataItems.getLatitude(), dataItems.getLongitude()),new LatLng(ur_lat, ur_lon)));
//
//
//                            }
//
